                    ...
                    {booking.bookingStatus === 'Confirmed' && (
                      <>
                        <button
                          ...
                          disabled={PROPERTY_TYPE === 'hotel' && new Date().getHours() < 14}
                          title={PROPERTY_TYPE === 'hotel' && new Date().getHours() < 14 ? 'Check-in opens at 2:00 PM' : 'Check In Guest'}
                          style={PROPERTY_TYPE === 'hotel' && new Date().getHours() < 14 ? { opacity: 0.5, cursor: 'not-allowed' } : {}}
                        >Check In</button>
